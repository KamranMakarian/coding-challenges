...
WashingMachine:
Implements turnOn() and turnOff() with messages like "Washing Machine is now ON" and "Washing Machine is now OFF".
Refrigerator:
Implements turnOn() and turnOff() with messages like "Refrigerator is now ON" and "Refrigerator is now OFF".
Microwave:
Implements turnOn() and turnOff() with messages like "Microwave is now ON" and "Microwave is now OFF".
Create a RemoteControl class:

This class should contain a method operateAppliance(Appliance appliance, boolean turnOn):
...
Create objects of each appliance type (WashingMachine, Refrigerator, Microwave).
...
This should demonstrate polymorphism, as the RemoteControl interacts with each appliance through the common Appliance interface.*/
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Turning on appliances:");

        remoteControl.operateAppliance(washingMachine,true);
        remoteControl.operateAppliance(refrigerator,true);
        remoteControl.operateAppliance(microwave,true);

        System.out.println("\nTurning off appliances:");

        remoteControl.operateAppliance(washingMachine,false);
        remoteControl.operateAppliance(refrigerator,false);
        remoteControl.operateAppliance(microwave,false);
    }
}